...
function iniciar() {
    ...
    if ("serviceWorker" in navigator) {
        navigator.serviceWorker.register("./sw_v25_13.js?v=25.13").catch(error => {
...
async function cargarDatosProduccion() {
    try {
        cambiarEstado("Cargando datos operativos precargados...", "carga");
        ...
        mostrarAvisoCRC(
            ...
            "Si está probando localmente, abra la carpeta mediante un servidor local (por ejemplo, Live Server) y no directamente con file://.\n\n" +
            error.message
        );
    }
}
